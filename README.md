...
1.npm install [electron@3.x](https://github.com/electron/electron/issues/15365) -g([尽量使用3.x版本,最新版本重启应用后会有cookie丢失问题](https://github.com/electron/electron/issues/15365))  
2.	npm isntall   
